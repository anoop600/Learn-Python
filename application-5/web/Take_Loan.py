...
from helper import verify_credentials, cash_with_user, update_account, debt_with_user, generate_return_dictionary, update_debt
...
class TakeLoan(Resource):
    def post(self):
        ...
        return generate_return_dictionary(200, "Loan added to your account")
